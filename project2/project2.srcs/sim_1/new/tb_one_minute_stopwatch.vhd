...
architecture testbench of tb_stopwatch_seconds is
    ...
    signal s_run_time     :   std_logic_vector(2 downto 0);    --! Input run time
...
begin
    ...
    uut_stopwatch : entity work.stopwatch_seconds
        port map(
            ...
            i_round       => s_round,    --! Input round count, max 16
            i_run_time     => s_run_time,    --! Input run time
            i_rest_time   => s_rest_time    --! Input rest time
